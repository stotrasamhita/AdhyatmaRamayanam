% !TeX program = XeLaTeX
% !TeX root = AdhyatmaRamayanaBook-print.tex
...
\input{TeX/Mahatmyam}
\input{TeX/BalaKanda}
\input{TeX/AyodhyaKanda}
\input{TeX/AranyaKanda}
\input{TeX/KishkindhaKanda}
\input{TeX/SundaraKanda}
\input{TeX/YuddhaKanda}
\input{TeX/UttaraKanda}
 \end{center}
\closesection
